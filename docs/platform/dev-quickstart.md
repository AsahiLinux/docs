...
Read [Boot](open-os-interop.md) and [PC Boot Process Differences](pc-boot-differences.md) for more info.
...
* [Boot](open-os-interop.md)
* [PC Boot Process Differences](pc-boot-differences.md)
* [NVRAM](../fw/nvram.md)
...
See [USB-PD](../hw/soc/usb-pd.md) for details on the USB-PD VDM commands and what you can do with them.
