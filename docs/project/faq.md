...
[Not yet](https://github.com/AsahiLinux/asahi-installer/issues/250). It is currently necessary to keep an *internal* macOS installation to install Asahi Linux, update/repair m1n1 and resize active Asahi Linux installations.
