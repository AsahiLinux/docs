...
| ------- | --------------- | ----- |
| cuttlefish |  | downstream patches: [bionic](https://r.android.com/2083840), [build/soong](https://r.android.com/2084588), [external/scudo](https://github.com/pcc/llvm-project/tree/scudo-bionic-page-size) |
...
| Visual Studio Code (Insiders) | https://aur.archlinux.org/packages/visual-studio-code-insiders-bin | Fixed since 1.71.0-insider (uses Electron 19) |