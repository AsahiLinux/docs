This is a small-ish reference kernel configuration for bare-metal Linux on Apple Silicon Macs.  It was tested and confirmed to boot without issue on a M1 MacBook Air running linux-asahi-6.6-14.  It should help you start the distro-porting process without being forced to build the entirety of the Fedora Asahi Remix kernel.
...
CONFIG_PROFILING=y
CONFIG_RUST=y
CONFIG_RUSTC_VERSION_TEXT="rustc 1.74.0 (79e9716c9 2023-11-13) (built from a source tarball)"
...
CONFIG_LSM="yama,apparmor,landlock,bpf"
...
CONFIG_SYSTEM_EXTRA_CERTIFICATE_SIZE=16384
