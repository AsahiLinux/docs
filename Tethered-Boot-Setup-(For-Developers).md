...
This process may take a couple of minutes. Once this is completed, your machine is now ready to boot into `m1n1` and be fed a kernel from a host Linux machine. Do _not_ reboot your machine just yet!
...
* MacBooks _will_ charge under Linux, there is no need to reboot into macOS to charge them.
